    ...
    def apply(self, background_dir, class_name):
        ...
        try:
            ...
            for _ in range(n_defects):
                ...
                roi_wo = int(random.gauss((image.shape[1] - defect.shape[1])/2, (image.shape[1] - defect.shape[1])/10))
            ...
            # import pdb
            # pdb.set_trace()
            print("Cannot make defected image : roi.shape != defect.shape or 0 in shape")
